...
private:
	...
	std::shared_ptr<Sprite2D>	Pass_over_gate_button;
	...
	std::shared_ptr<Sprite2D>	W_button_1;
	std::shared_ptr<Sprite2D>	A_button_1;
	...
	std::shared_ptr<Text>					m_Adventure;
	std::shared_ptr<Text>					m_Maze;
