...
GSOptions::GSOptions() : GameStateBase(StateType::STATE_OPTION),
...
void GSOptions::HandleKeyEvents(SDL_Event& e)
{
...
void GSOptions::HandleTouchEvents(SDL_Event& e)
{
...
void GSOptions::HandleMouseMoveEvents(int x, int y)
{
}
...
void GSOptions::Draw(SDL_Renderer* renderer)
{
